<!DOCTYPE html>
<html> 
    <title>C13 IEC 10A MAINS REWIREABLE SOCKET</title> 
    <head> 
        <meta charset="UTF-8">
    ...
    <body>
        <div class="pContainer">
            ...
            <img src="produktet\PB5171.jpg" id='LargeImage' alt="Power Bank" class="p_main"></img>

            <div>
            <img src="produktet\PB5171.jpg" alt="Power Bank" class="p_preview" id="PowerBank1" onclick="NextImage(0)"></img>
        </div>
            ...
            <div class="p_info">
                <p class="ProductTitle">C13 IEC 10A MAINS REWIREABLE SOCKET </p>
